...
namespace ETicaretAPI.Infrastructure.Services
{
    public class FileService : IFileService
    {
        ...
        //todo Fonksiyon içindeki adlandırma kontrol etme mekanizmasını geliştirmemiz gerekecek.
        ...
        public async Task<IList<(string fileName, string path)>> UploadAsync(string path, IFormFileCollection files)
        {
